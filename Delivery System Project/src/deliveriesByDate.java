...
public class deliveriesByDate extends JFrame {
	...
	public deliveriesByDate(Managers manager) {
		...
		contentPane.add(scrollPane);
		 DefaultTableModel model = (DefaultTableModel) table.getModel();
	        ...
	        Object[] culomn = {"destination","date","distance","Price","member id","code","price per km"};
	        ...
	        table.setModel(model);
		     ...
		     btnNewButton_1.addActionListener(new ActionListener() {
		     	public void actionPerformed(ActionEvent e) {
					...
					StringTokenizer s;
					try {
						/*I take the date from the ShortDeliveries file and check if it is equals to the date we entered in the textfield if yes then I fill the jtable is required.*/
